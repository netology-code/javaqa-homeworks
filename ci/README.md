# Домашнее задание к занятию «2.5. Домашнее задание к занятию «Выстраивание процесса непрерывной интеграции (`CI`): `Github Actions`. Покрытие кода с `JaCoCo`, статический анализ кода: `CheckStyle`, `SpotBugs`»
