...
На основе [проекта с лекции](https://github.com/netology-code/javaqa-code/tree/master/3.4_dependency/cart) необходимо реализовать менеджер Афиши (все фильмы хранятся внутри самого менеджера в массиве, без всякого репозитория):
